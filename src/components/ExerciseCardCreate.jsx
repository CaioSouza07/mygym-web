    ...
    <Card className="p-4! gap-3! items-start!">
      ...
      <div className="flex flex-wrap items-center gap-2 w-full">
        {exercise.series.map((serie) => (
          ...
          >
            <span className="text-white/50 text-sm font-medium">S{serie.order}</span>
            <input
              type="number"
        ...
        <button className="flex items-center justify-center bg-zinc-900 border border-dashed border-zinc-600 hover:border-[#FFCC00]/50 rounded-lg px-3 py-2 cursor-pointer transition-colors">
